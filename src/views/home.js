...
const Home = (props) => {
  return (
    <div className="home-container">
      <Helmet>
        <title>The Good Housemate</title>
        <meta property="og:title" content="The Good Housemate" />
      </Helmet>
        ...
        <header data-thq="thq-navbar" className="home-navbar-interactive">
          ...
          >
            <nav
              ...
              className="home-nav"
            >
              <Link to="/calendar" className="home-navlink1">
                <span>Calendar</span>
                <br></br>
              </Link>
              <Link to="/chores" className="home-navlink2">
                Chores
              </Link>
              <Link to="/costsplitting" className="home-navlink3">
                Costs
              </Link>
              <Link to="/messaging" className="home-navlink4">
                Messaging
              </Link>
            </nav>
          </div>
          <div data-thq="thq-navbar-btn-group" className="home-btn-group">
            ...
            <button className="button home-register">
              <svg viewBox="0 0 731.4285714285713 1024" className="home-icon02">
      ...
      <div className="home-container05">
        <div className="home-container06">
          ...
          <img
            alt="image"
            src="/playground_assets/studenthouse-500h.jpeg"
        ...
        <div className="home-container09">
          ...
          <div className="home-container12">
            ...
            />
            <Link to="/messaging" className="home-navlink5 button">
              Denise
            </Link>
          </div>
          <div className="home-container13">
            <div className="home-container14">
              ...
              />
              <Link to="/messaging" className="home-navlink6 button">
                Namit
              </Link>
            </div>
            <div className="home-container15">
              ...
              />
              <Link to="/messaging" className="home-navlink7 button">
                Meghan
              </Link>
            </div>
            <div className="home-container16">
              ...
              <button className="home-button1 button">
                <span className="home-text23">Invite</span>
              </button>
            </div>
          </div>
        </div>
